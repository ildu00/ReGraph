...
serve(async (req) => {
  ...
  try {
    ...
    const modelMapping: Record<string, string> = {
      ...
      "bge-large-en": "emb-openai/text-embedding-3-small",
      "e5-mistral-7b": "emb-openai/text-embedding-3-large",
      "nomic-embed-v1.5": "emb-openai/text-embedding-3-small",
      "nomic-ai/nomic-embed-v1.5": "emb-openai/text-embedding-3-small",
      "nomic-ai/Nomic-Embed-v1.5": "emb-openai/text-embedding-3-small",
      "text-embedding-ada-002": "emb-openai/text-embedding-ada-002",
      "text-embedding-3-small": "emb-openai/text-embedding-3-small",
      "text-embedding-3-large": "emb-openai/text-embedding-3-large",
