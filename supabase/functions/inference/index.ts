...
serve(async (req) => {
  ...
  try {
    ...
    const inferenceBody: Record<string, unknown> = { model: model || (isImageGenEndpoint ? "dall-e-3" : "llama-3.1-70b"), prompt: finalPrompt, temperature: temperature ?? 0.7, maxTokens: max_tokens ?? 40000, category };
