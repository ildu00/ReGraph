...
const modelsData: Model[] = [
  ...
  // Image-to-Video
  { id: "img2vid-ltx/pro-2.3-xsec-with-audio", name: "LTX 2.3 Pro (Image-to-Video, with audio)", provider: "LightTricks", category: "img2vid", description: "Professional LTX 2.3 image-to-video with audio. Supports 6–20s generation and optional last frame hint.", pricing: "$0.167/sec", latency: "Variable", tags: ["Audio", "Last Frame", "6-20s"], isNew: true },
  { id: "img2vid-kling/o3-pro-xsec-with-audio", name: "Kling O3 Pro (Image-to-Video, with audio)", provider: "Kling AI", category: "img2vid", description: "Professional Kling O3 image-to-video with audio. Supports 3–15s and optional last frame.", pricing: "$0.422/sec", latency: "Variable", tags: ["Audio", "Last Frame", "3-15s", "Professional"], isPopular: true, isNew: true },
  { id: "img2vid-kling/o3-pro-xsec", name: "Kling O3 Pro (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Professional Kling O3 image-to-video without audio. Supports 3–15s and optional last frame.", pricing: "$0.311/sec", latency: "Variable", tags: ["Last Frame", "3-15s", "Professional"], isNew: true },
  { id: "img2vid-kling/o3-standart-xsec-with-audio", name: "Kling O3 Standard (Image-to-Video, with audio)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling O3 image-to-video with audio. 3–15s, optional last frame.", pricing: "$0.311/sec", latency: "Variable", tags: ["Audio", "Best Value", "3-15s"], isPopular: true, isNew: true },
  { id: "img2vid-kling/o3-standart-xsec", name: "Kling O3 Standard (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling O3 image-to-video without audio. 3–15s, optional last frame.", pricing: "$0.221/sec", latency: "Variable", tags: ["Best Value", "3-15s", "Affordable"], isNew: true },
  { id: "img2vid-kling/standart25-turbo-10s", name: "Kling Standard Turbo 2.5 (10s, Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Standard Turbo 2.5 for 10-second image-to-video generation.", pricing: "$1.10/video", latency: "~30s", tags: ["10s", "Turbo", "Best Value"], isNew: true },
  { id: "img2vid-kling/standart25-turbo", name: "Kling Standard Turbo 2.5 (5s, Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Standard Turbo 2.5 for 5-second image-to-video generation.", pricing: "$0.55/video", latency: "~20s", tags: ["5s", "Turbo", "Best Value"], isNew: true },
  { id: "img2vid-kling/pro25-turbo-10s", name: "Kling Pro Turbo 2.5 (10s, Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Pro Turbo 2.5 for 10-second professional image-to-video.", pricing: "$2.00/video", latency: "~35s", tags: ["10s", "Turbo", "Professional"], isNew: true },
  { id: "img2vid-kling/pro25-turbo", name: "Kling Pro Turbo 2.5 (5s, Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Pro Turbo 2.5 for 5-second professional image-to-video.", pricing: "$1.00/video", latency: "~25s", tags: ["5s", "Turbo", "Professional"], isNew: true },
  { id: "img2vid-openai/sora-2-pro-audio-8s", name: "Sora 2 Pro (8s, with audio, Image-to-Video)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 Pro image-to-video with audio, 8-second output.", pricing: "$6.66/video", latency: "~70s", tags: ["8s", "Audio", "Pro", "Premium"], isNew: true },
  { id: "img2vid-openai/sora-2-pro-audio", name: "Sora 2 Pro (4s, with audio, Image-to-Video)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 Pro image-to-video with audio, 4-second output.", pricing: "$3.32/video", latency: "~55s", tags: ["4s", "Audio", "Pro", "Premium"], isNew: true },
  { id: "img2vid-openai/sora-2-audio-8s", name: "Sora 2 (8s, with audio, Image-to-Video)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 image-to-video with audio, 8-second output.", pricing: "$2.20/video", latency: "~65s", tags: ["8s", "Audio", "OpenAI"], isNew: true },
  { id: "img2vid-openai/sora-2-audio", name: "Sora 2 (4s, with audio, Image-to-Video)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 image-to-video with audio, 4-second output.", pricing: "$1.10/video", latency: "~50s", tags: ["4s", "Audio", "OpenAI"], isNew: true },
  { id: "img2vid-google/veo3.1-fast-first-last-frame-with-audio", name: "Google Veo 3.1 Fast (first+last frame, with audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 image-to-video with first and last frame control, including audio.", pricing: "$2.66/video", latency: "~45s", tags: ["First+Last Frame", "Audio", "Top"], isPopular: true, isNew: true },
  { id: "img2vid-google/veo3.1-fast-first-last-frame-no-audio", name: "Google Veo 3.1 Fast (first+last frame, no audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 image-to-video with first and last frame control, no audio.", pricing: "$1.77/video", latency: "~40s", tags: ["First+Last Frame", "Top", "Google"], isNew: true },
  { id: "img2vid-google/veo3.1-fast-with-audio", name: "Google Veo 3.1 Fast (Image-to-Video, with audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 image-to-video with synchronized audio.", pricing: "$2.66/video", latency: "~45s", tags: ["Audio", "Top", "Google"], isPopular: true, isNew: true },
  { id: "img2vid-google/veo3.1-fast-no-audio", name: "Google Veo 3.1 Fast (Image-to-Video, no audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 image-to-video without audio.", pricing: "$1.77/video", latency: "~40s", tags: ["Top", "Google", "High Quality"], isNew: true },
  { id: "img2vid-kling/master21", name: "Kling Master v2.1 (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Flagship Kling Master v2.1 for maximum quality image-to-video generation.", pricing: "$3.33/video", latency: "~60s", tags: ["Flagship", "Max Quality", "Premium"], isNew: true },
  { id: "img2vid-kling/pro21", name: "Kling Pro v2.1 (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Professional Kling v2.1 image-to-video generation.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v2.1"], isNew: true },
  { id: "img2vid-kling/standart21", name: "Kling Standard v2.1 (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Standard Kling v2.1 image-to-video — balanced quality and cost.", pricing: "$0.67/video", latency: "~35s", tags: ["Standard", "v2.1", "Balanced"], isNew: true },
  { id: "img2vid-ltx/097-distilled", name: "LTX 0.9.7 (Image-to-Video, fast)", provider: "LightTricks", category: "img2vid", description: "Fast distilled LTX 0.9.7 for rapid image-to-video generation.", pricing: "$0.13/video", latency: "~12s", tags: ["Fast", "Distilled", "Affordable"], isNew: true },
  { id: "img2vid-ltx/video-095", name: "LTX 0.9.5 (Image-to-Video)", provider: "LightTricks", category: "img2vid", description: "LTX 0.9.5 image-to-video model.", pricing: "$0.13/video", latency: "~15s", tags: ["Open Source", "Affordable", "LTX"], isNew: true },
  { id: "img2vid-kling/pro16", name: "Kling Pro v1.6 (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Professional Kling v1.6 image-to-video.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v1.6"], isNew: true },
  { id: "img2vid-kling/standart16", name: "Kling Standard v1.6 (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Standard Kling v1.6 image-to-video — balanced quality and cost.", pricing: "$0.55/video", latency: "~30s", tags: ["Standard", "v1.6", "Balanced"], isNew: true },
  { id: "img2vid-kling/pro15", name: "Kling Pro v1.5 (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Professional Kling v1.5 image-to-video.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v1.5"], isNew: true },
  { id: "img2vid-kling/standart", name: "Kling Standard (Image-to-Video)", provider: "Kling AI", category: "img2vid", description: "Standard Kling image-to-video — affordable entry-level generation.", pricing: "$0.55/video", latency: "~30s", tags: ["Standard", "Affordable", "Entry Level"] },
...
const categoryTitles: Record<string, string> = {
  ...
  tts: "Text-to-Speech",
  video: "Video Generation (txt2vid)",
