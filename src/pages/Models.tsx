...
const modelsData: Model[] = [
  ...
  { id: "txt2vid-kling/pro16", name: "Kling Pro v1.6", provider: "Kling AI", category: "video", description: "Professional Kling v1.6 model for high-quality video generation.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v1.6", "High Quality"], isNew: true },
