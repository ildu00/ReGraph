...
const modelsData: Model[] = [
  ...
  // --- DeepSeek V4 family ---
  { id: "deepseek/deepseek-v4-pro-alt-thinking", name: "DeepSeek V4 Pro 1.6T (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "Professional 1.6T flagship for general questions and coding with extended reasoning. Tools, structured outputs.", contextLength: 1000000, pricing: "$0.0018/1K", latency: "~900ms", tags: ["1M Context", "Thinking", "Tools"], isNew: true },
  { id: "deepseek/deepseek-v4-pro-alt", name: "DeepSeek V4 Pro 1.6T (Alt)", provider: "DeepSeek", category: "llm", description: "Professional 1.6T flagship for general questions and coding. Tools, structured outputs.", contextLength: 1000000, pricing: "$0.0018/1K", latency: "~700ms", tags: ["1M Context", "Tools", "Structured"], isNew: true },
  { id: "deepseek/deepseek-v4-flash-alt-thinking", name: "DeepSeek V4 Flash 284B (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "Fast 284B MoE with extended reasoning. Tools and structured outputs.", contextLength: 1000000, pricing: "$0.00018/1K", latency: "~400ms", tags: ["1M Context", "Fast", "Thinking"], isNew: true },
  { id: "deepseek/deepseek-v4-flash-alt", name: "DeepSeek V4 Flash 284B (Alt)", provider: "DeepSeek", category: "llm", description: "Fast 284B MoE for general questions and coding. Tools, structured outputs.", contextLength: 1000000, pricing: "$0.00018/1K", latency: "~300ms", tags: ["1M Context", "Fast", "Tools"], isNew: true },
  { id: "deepseek/deepseek-v4-pro-thinking", name: "DeepSeek V4 Pro 1.6T (Thinking)", provider: "DeepSeek", category: "reasoning", description: "Ultra-cheap 1.6T flagship with extended reasoning. Tools supported.", contextLength: 1000000, pricing: "$0.00055/1K", latency: "~900ms", tags: ["1M Context", "Thinking", "Cheap"], isNew: true },
  { id: "deepseek/deepseek-v4-pro", name: "DeepSeek V4 Pro 1.6T", provider: "DeepSeek", category: "llm", description: "Ultra-cheap 1.6T flagship for general questions and coding. Tools supported.", contextLength: 1000000, pricing: "$0.00055/1K", latency: "~700ms", tags: ["1M Context", "Tools", "Cheap"], isNew: true },
  { id: "deepseek/deepseek-v4-flash-thinking", name: "DeepSeek V4 Flash 284B (Thinking)", provider: "DeepSeek", category: "reasoning", description: "Fast 284B MoE with extended reasoning. Tools supported.", contextLength: 1000000, pricing: "$0.00013/1K", latency: "~400ms", tags: ["1M Context", "Fast", "Thinking"], isNew: true },
  { id: "deepseek/deepseek-v4-flash", name: "DeepSeek V4 Flash 284B", provider: "DeepSeek", category: "llm", description: "Fast 284B MoE for general questions and coding. Tools supported.", contextLength: 1000000, pricing: "$0.00013/1K", latency: "~300ms", tags: ["1M Context", "Fast", "Tools"], isNew: true },
  { id: "deepseek/deepseek-chat", name: "DeepSeek Chat V4 Flash", provider: "DeepSeek", category: "llm", description: "Latest DeepSeek Chat routed to V4 Flash. Tools supported.", contextLength: 1000000, pricing: "$0.00013/1K", latency: "~320ms", tags: ["1M Context", "Latest", "Tools"], isNew: true },
  { id: "deepseek/deepseek-coder", name: "DeepSeek Coder (universal)", provider: "DeepSeek", category: "code", description: "Coder alias — now a universal model routed to DeepSeek Chat.", contextLength: 128000, pricing: "$0.00018/1K", latency: "~300ms", tags: ["Coding", "Universal"] },
  // --- DeepSeek V3.2 family ---
  { id: "deepseek/deepseek-v3.2-alt-faster", name: "DeepSeek V3.2 671B (Alt, Faster)", provider: "DeepSeek", category: "llm", description: "Faster 671B general-purpose model with tools and structured outputs.", contextLength: 162000, pricing: "$0.00025/1K", latency: "~350ms", tags: ["162K", "Faster", "Tools"] },
  { id: "deepseek/deepseek-v3.2-speciale-alt", name: "DeepSeek V3.2 Speciale 671B (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "Specialized 671B for reasoning and analysis.", contextLength: 162000, pricing: "$0.00018/1K", latency: "~800ms", tags: ["162K", "Reasoning", "Analysis"] },
  { id: "deepseek/deepseek-v3.2-alt-thinking", name: "DeepSeek V3.2 671B (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "671B general-purpose model with extended reasoning. Tools supported.", contextLength: 162000, pricing: "$0.00018/1K", latency: "~700ms", tags: ["162K", "Thinking", "Tools"] },
  { id: "deepseek/deepseek-v3.2-alt", name: "DeepSeek V3.2 671B (Alt)", provider: "DeepSeek", category: "llm", description: "671B general-purpose model with tools.", contextLength: 162000, pricing: "$0.00018/1K", latency: "~400ms", tags: ["162K", "Tools"] },
  { id: "deepseek/deepseek-v3.2-exp-alt-thinking", name: "DeepSeek V3.2 Exp 671B (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "Experimental 671B with extended reasoning. Tools supported.", contextLength: 162000, pricing: "$0.00018/1K", latency: "~700ms", tags: ["Experimental", "Thinking"] },
  { id: "deepseek/deepseek-v3.2-exp-alt", name: "DeepSeek V3.2 Exp 671B (Alt)", provider: "DeepSeek", category: "llm", description: "Experimental 671B general-purpose model with tools.", contextLength: 162000, pricing: "$0.00018/1K", latency: "~400ms", tags: ["Experimental", "Tools"] },
  // --- DeepSeek V3.1 family ---
  { id: "deepseek/deepseek-chat-3.1-alt-fast", name: "DeepSeek V3.1 671B (Alt, Fast)", provider: "DeepSeek", category: "llm", description: "Fast variant of V3.1 671B. Tools and structured outputs.", contextLength: 162000, pricing: "$0.00090/1K", latency: "~250ms", tags: ["162K", "Fast", "Tools"] },
  { id: "deepseek/deepseek-chat-3.1-terminus-alt-thinking", name: "DeepSeek V3.1 Terminus 671B (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "Terminus edition of V3.1 with extended reasoning. Tools, structured outputs.", contextLength: 162000, pricing: "$0.00080/1K", latency: "~700ms", tags: ["162K", "Terminus", "Thinking"] },
  { id: "deepseek/deepseek-chat-3.1-terminus-alt", name: "DeepSeek V3.1 Terminus 671B (Alt)", provider: "DeepSeek", category: "llm", description: "Terminus edition of V3.1 671B. Tools, structured outputs.", contextLength: 162000, pricing: "$0.00080/1K", latency: "~500ms", tags: ["162K", "Terminus", "Tools"] },
  { id: "deepseek/deepseek-chat-3.1-alt-thinking", name: "DeepSeek V3.1 671B (Thinking, Alt)", provider: "DeepSeek", category: "reasoning", description: "V3.1 671B with extended reasoning. Tools, structured outputs.", contextLength: 162000, pricing: "$0.00080/1K", latency: "~700ms", tags: ["162K", "Thinking", "Tools"] },
  { id: "deepseek/deepseek-chat-3.1-alt", name: "DeepSeek V3.1 671B (Alt)", provider: "DeepSeek", category: "llm", description: "V3.1 671B general-purpose model. Tools, structured outputs.", contextLength: 162000, pricing: "$0.00080/1K", latency: "~500ms", tags: ["162K", "Tools"] },
  // --- DeepSeek R1 & V3 legacy ---
  { id: "deepseek/deepseek-r1-alt-0528", name: "DeepSeek R1 (05-28, Alt)", provider: "DeepSeek", category: "reasoning", description: "R1 competitor to o1, alternative provider release 05-28.", contextLength: 128000, pricing: "$0.0011/1K", latency: "~1s", tags: ["o1-style", "Reasoning"] },
  { id: "deepseek/deepseek-r1-alt-fast", name: "DeepSeek R1 (Alt, Fast)", provider: "DeepSeek", category: "reasoning", description: "Faster but pricier R1 for reasoning.", contextLength: 163840, pricing: "$0.0037/1K", latency: "~600ms", tags: ["Fast", "Reasoning"] },
  { id: "deepseek/deepseek-r1-distill-llama-70b", name: "DeepSeek R1 Distill Llama 70B", provider: "DeepSeek", category: "reasoning", description: "R1 distillation on top of Llama 3.3 70B for reasoning.", contextLength: 128000, pricing: "$0.00055/1K", latency: "~600ms", tags: ["Distilled", "Llama", "Reasoning"] },
  { id: "deepseek/deepseek-chat-0324-alt-fast", name: "DeepSeek V3 0324 600B (Alt, Fast)", provider: "DeepSeek", category: "llm", description: "Fast alternative-provider V3 0324 600B for general use and coding.", contextLength: 128000, pricing: "$0.00080/1K", latency: "~300ms", tags: ["Fast", "Coding"] },
  { id: "deepseek/deepseek-chat-0324-alt", name: "DeepSeek V3 0324 600B (Alt)", provider: "DeepSeek", category: "llm", description: "V3 0324 600B via alternative providers.", contextLength: 128000, pricing: "$0.00059/1K", latency: "~400ms", tags: ["V3", "Coding"] },
  { id: "deepseek/deepseek-chat-alt", name: "DeepSeek V3 600B (Alt, legacy)", provider: "DeepSeek", category: "llm", description: "Legacy V3 600B alias — migrate to deepseek-chat-0324-alt.", contextLength: 128000, pricing: "$0.00059/1K", latency: "~400ms", tags: ["Legacy", "V3"] },
  // --- AionLabs ---
  { id: "aion/aion-2.0", name: "AionLabs Aion 2.0", provider: "AionLabs", category: "chat", description: "Roleplay model built on DeepSeek 3.2 with extended reasoning.", contextLength: 128000, pricing: "$0.00090/1K", latency: "~600ms", tags: ["Roleplay", "Thinking"] },
  // --- Perplexity ---
  { id: "perplexity/sonar-r1-online", name: "Perplexity Sonar Reasoning", provider: "Perplexity", category: "reasoning", description: "Online reasoning model built on DeepSeek R1. Includes web access.", contextLength: 127000, pricing: "$0.0026/1K", latency: "~1.5s", tags: ["Online", "Web Access", "Reasoning"] },
  ...
  // Image-to-Video
  { id: "img2vid-ltx/pro-2.3-xsec-with-audio", name: "LTX 2.3 Pro (with audio, 6-20s)", provider: "LightTricks", category: "img2vid", description: "Professional LTX 2.3 with audio. Supports 6–20s generation and optional last frame hint.", pricing: "$0.167/sec", latency: "Variable", tags: ["Audio", "Last Frame", "6-20s"], isNew: true },
  { id: "img2vid-kling/o3-pro-xsec-with-audio", name: "Kling O3 Pro (with audio, 3-15s)", provider: "Kling AI", category: "img2vid", description: "Professional Kling O3 with audio. Supports 3–15s and optional last frame.", pricing: "$0.422/sec", latency: "Variable", tags: ["Audio", "Last Frame", "3-15s", "Professional"], isPopular: true, isNew: true },
  { id: "img2vid-kling/o3-pro-xsec", name: "Kling O3 Pro (3-15s)", provider: "Kling AI", category: "img2vid", description: "Professional Kling O3 without audio. Supports 3–15s and optional last frame.", pricing: "$0.311/sec", latency: "Variable", tags: ["Last Frame", "3-15s", "Professional"], isNew: true },
  { id: "img2vid-kling/o3-standart-xsec-with-audio", name: "Kling O3 Standard (with audio, 3-15s)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling O3 with audio. 3–15s, optional last frame.", pricing: "$0.311/sec", latency: "Variable", tags: ["Audio", "Best Value", "3-15s"], isPopular: true, isNew: true },
  { id: "img2vid-kling/o3-standart-xsec", name: "Kling O3 Standard (3-15s)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling O3 without audio. 3–15s, optional last frame.", pricing: "$0.221/sec", latency: "Variable", tags: ["Best Value", "3-15s", "Affordable"], isNew: true },
  { id: "img2vid-kling/standart25-turbo-10s", name: "Kling Standard Turbo 2.5 (10s)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Standard Turbo 2.5, 10-second output.", pricing: "$1.10/video", latency: "~30s", tags: ["10s", "Turbo", "Best Value"], isNew: true },
  { id: "img2vid-kling/standart25-turbo", name: "Kling Standard Turbo 2.5 (5s)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Standard Turbo 2.5, 5-second output.", pricing: "$0.55/video", latency: "~20s", tags: ["5s", "Turbo", "Best Value"], isNew: true },
  { id: "img2vid-kling/pro25-turbo-10s", name: "Kling Pro Turbo 2.5 (10s)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Pro Turbo 2.5, 10-second professional output.", pricing: "$2.00/video", latency: "~35s", tags: ["10s", "Turbo", "Professional"], isNew: true },
  { id: "img2vid-kling/pro25-turbo", name: "Kling Pro Turbo 2.5 (5s)", provider: "Kling AI", category: "img2vid", description: "Best price/quality Kling Pro Turbo 2.5, 5-second professional output.", pricing: "$1.00/video", latency: "~25s", tags: ["5s", "Turbo", "Professional"], isNew: true },
  { id: "img2vid-openai/sora-2-pro-audio-8s", name: "Sora 2 Pro (with audio, 8s)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 Pro with audio, 8-second output.", pricing: "$6.66/video", latency: "~70s", tags: ["8s", "Audio", "Pro", "Premium"], isNew: true },
  { id: "img2vid-openai/sora-2-pro-audio", name: "Sora 2 Pro (with audio, 4s)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 Pro with audio, 4-second output.", pricing: "$3.32/video", latency: "~55s", tags: ["4s", "Audio", "Pro", "Premium"], isNew: true },
  { id: "img2vid-openai/sora-2-audio-8s", name: "Sora 2 (with audio, 8s)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 with audio, 8-second output.", pricing: "$2.20/video", latency: "~65s", tags: ["8s", "Audio", "OpenAI"], isNew: true },
  { id: "img2vid-openai/sora-2-audio", name: "Sora 2 (with audio, 4s)", provider: "OpenAI", category: "img2vid", description: "OpenAI Sora 2 with audio, 4-second output.", pricing: "$1.10/video", latency: "~50s", tags: ["4s", "Audio", "OpenAI"], isNew: true },
  { id: "img2vid-google/veo3.1-fast-first-last-frame-with-audio", name: "Google Veo 3.1 Fast (first+last frame, with audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 with first and last frame control, including audio.", pricing: "$2.66/video", latency: "~45s", tags: ["First+Last Frame", "Audio", "Top"], isPopular: true, isNew: true },
  { id: "img2vid-google/veo3.1-fast-first-last-frame-no-audio", name: "Google Veo 3.1 Fast (first+last frame, no audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 with first and last frame control, no audio.", pricing: "$1.77/video", latency: "~40s", tags: ["First+Last Frame", "Top", "Google"], isNew: true },
  { id: "img2vid-google/veo3.1-fast-with-audio", name: "Google Veo 3.1 Fast (with audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 with synchronized audio.", pricing: "$2.66/video", latency: "~45s", tags: ["Audio", "Top", "Google"], isPopular: true, isNew: true },
  { id: "img2vid-google/veo3.1-fast-no-audio", name: "Google Veo 3.1 Fast (no audio)", provider: "Google", category: "img2vid", description: "Top-tier Google Veo 3.1 without audio.", pricing: "$1.77/video", latency: "~40s", tags: ["Top", "Google", "High Quality"], isNew: true },
  { id: "img2vid-kling/master21", name: "Kling Master v2.1", provider: "Kling AI", category: "img2vid", description: "Flagship Kling Master v2.1 for maximum quality generation.", pricing: "$3.33/video", latency: "~60s", tags: ["Flagship", "Max Quality", "Premium"], isNew: true },
  { id: "img2vid-kling/pro21", name: "Kling Pro v2.1", provider: "Kling AI", category: "img2vid", description: "Professional Kling v2.1 generation.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v2.1"], isNew: true },
  { id: "img2vid-kling/standart21", name: "Kling Standard v2.1", provider: "Kling AI", category: "img2vid", description: "Standard Kling v2.1 — balanced quality and cost.", pricing: "$0.67/video", latency: "~35s", tags: ["Standard", "v2.1", "Balanced"], isNew: true },
  { id: "img2vid-ltx/097-distilled", name: "LTX 0.9.7 (fast)", provider: "LightTricks", category: "img2vid", description: "Fast distilled LTX 0.9.7 for rapid generation.", pricing: "$0.13/video", latency: "~12s", tags: ["Fast", "Distilled", "Affordable"], isNew: true },
  { id: "img2vid-ltx/video-095", name: "LTX 0.9.5", provider: "LightTricks", category: "img2vid", description: "LTX 0.9.5 model.", pricing: "$0.13/video", latency: "~15s", tags: ["Open Source", "Affordable", "LTX"], isNew: true },
  { id: "img2vid-kling/pro16", name: "Kling Pro v1.6", provider: "Kling AI", category: "img2vid", description: "Professional Kling v1.6.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v1.6"], isNew: true },
  { id: "img2vid-kling/standart16", name: "Kling Standard v1.6", provider: "Kling AI", category: "img2vid", description: "Standard Kling v1.6 — balanced quality and cost.", pricing: "$0.55/video", latency: "~30s", tags: ["Standard", "v1.6", "Balanced"], isNew: true },
  { id: "img2vid-kling/pro15", name: "Kling Pro v1.5", provider: "Kling AI", category: "img2vid", description: "Professional Kling v1.5.", pricing: "$1.67/video", latency: "~45s", tags: ["Professional", "v1.5"], isNew: true },
  { id: "img2vid-kling/standart", name: "Kling Standard", provider: "Kling AI", category: "img2vid", description: "Standard Kling — affordable entry-level generation.", pricing: "$0.55/video", latency: "~30s", tags: ["Standard", "Affordable", "Entry Level"] },
