...
curl -X POST https://api.regraph.tech/v1/inference \\
...
curl -X POST https://api.regraph.tech/v1/training/jobs \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  -d @payload.json`,
    body: `{
...
curl -X POST https://api.regraph.tech/v1/batch \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  -d @payload.json`,
    body: `{
...
curl -X POST https://api.regraph.tech/v1/provider/register \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  -d @payload.json`,
    body: `{
...
const apiEndpoints = [
  {
    ...
    request: `curl -X POST https://api.regraph.tech/v1/inference \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    request: `curl -X POST https://api.regraph.tech/v1/training/jobs \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    params: ["id"],
    request: `curl https://api.regraph.tech/v1/training/jobs/job_xyz789 \\
  -H "Authorization: Bearer YOUR_API_KEY"`,
    response: `{
  "id": "job_xyz789",
  "status": "running",
  ...
  },
  {
    ...
    request: `curl -X POST https://api.regraph.tech/v1/batch \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  ...
  },
  {
    ...
    request: `curl https://api.regraph.tech/v1/models?category=llm \\
  -H "Authorization: Bearer YOUR_API_KEY"`,
    response: `{
  "models": [
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 mb-6">
            {(Object.keys(codeExamples) as Array<keyof typeof codeExamples>).map((tab) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg font-mono text-sm transition-colors text-center ${
                  activeTab === tab
