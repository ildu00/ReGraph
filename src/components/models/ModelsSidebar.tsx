...
const categoryGroups = [
  ...
  },
  {
    ...
    categories: [
      ...
      { id: "music-gen", label: "Music Generation", icon: Music, count: 4 },
      { id: "video", label: "Text-to-Video", icon: Video, count: 12 },
      { id: "img2vid", label: "Image-to-Video", icon: Video, count: 27 },
    ]
  },
  {
    label: "Specialized",
